...
import "./DefiERC20.sol";
import "../interfaces/IDefiCallee.sol";
import "../interfaces/IDefiFactory.sol";
import "../interfaces/IDefiPair.sol";
import "../libraries/Math.sol";
import "../libraries/UQ112x112.sol";

// contract DefiPair is DefiERC20 {
contract DefiPair is IDefiPair, DefiERC20, ReentrancyGuard {
    ...
    modifier lock() {
        require(unlocked == 1, "DefiPair: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function initialize(address _token0, address _token1) external override {
        require(msg.sender == factory, "DefiPair: FORBIDDEN"); // sufficient check
        token0 = _token0;
        token1 = _token1;
    }
    ...
    function swap(
        ...
        uint256 balance1;
        {
            ...
            if (data.length > 0) IDefiCallee(to).defiCall(msg.sender, amount0Out, amount1Out, data);
            balance0 = IERC20(_token0).balanceOf(address(this));
            balance1 = IERC20(_token1).balanceOf(address(this));
        }
    ...
    function skim(address to) external override lock nonReentrant {
        address _token0 = token0; // gas savings
        address _token1 = token1; // gas savings
